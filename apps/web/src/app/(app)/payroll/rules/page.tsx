...
import type { SalaryRuleDto, SalaryStructureDto } from '@peoplepay360/shared';
...
export default async function RulesPage({
  ...
  const [rules, structures] = await Promise.all([
    apiGetOrRedirect<SalaryRuleDto[]>('/salary-rules', '/my-space', {
      structureId: params.structure,
      category: params.category,
      q: params.q,
    }),
    apiGetOrRedirect<SalaryStructureDto[]>('/salary-structures', '/my-space'),
  ]);
